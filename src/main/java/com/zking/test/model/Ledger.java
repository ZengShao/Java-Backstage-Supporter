...
public class Ledger {
    ...
    public Ledger(Long ledgerId, Long customerId, Long adminId, Long applyId, Date startTime, Date endTime, Date deferTime, Date endReturntime, String applyMoney, String ledgerInterest) {
